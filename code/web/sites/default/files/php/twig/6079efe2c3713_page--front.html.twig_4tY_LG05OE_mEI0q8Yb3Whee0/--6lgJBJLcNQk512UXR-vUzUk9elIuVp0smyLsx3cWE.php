...
/* themes/un_habitat_theme/templates/page--front.html.twig */
class __TwigTemplate_bbacbb8f2d7cd780978baa731af7f627aa065d505dfb4702438583f4fe977562 extends \Twig\Template
{
...
\t\t\t\t\t\t\t";
        // line 161
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["page"] ?? null), "recent_video", [])), "html", null, true);
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"col-md-6\">\t\t\t
...
\t\t\t\t\t\t\t\t";
        // line 166
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["page"] ?? null), "recent_news", [])), "html", null, true);
        echo "
\t\t\t\t\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
";
    ...
    {
        return "themes/un_habitat_theme/templates/page--front.html.twig";
    }
    ...
    {
        return array (  159 => 166,  151 => 161,  137 => 150,  49 => 65,  44 => 63,  32 => 53,);
    }
    ...
    {
        return new Source("", "themes/un_habitat_theme/templates/page--front.html.twig", "D:\\drupal\\mypsup\\web\\themes\\un_habitat_theme\\templates\\page--front.html.twig");
    }
